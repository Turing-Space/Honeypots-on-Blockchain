/*
 * Title: Innocent Log
 * Trick: Pretend to log event by "emails.delegatecall(bytes4(sha3("logEvent()")));" but modify the "adr"! (line 42)
 * Reference: https://etherscan.io/address/0x42dB5Bfe8828f12F164586AF8A992B3a7B038164#code
*/
